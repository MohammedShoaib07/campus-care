    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-teal-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <button
            onClick={() => navigate('/')}
            className="flex items-center text-teal-600 hover:text-teal-800 transition-colors duration-200 mb-8"
          >
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            {isLogin ? 'Access the management dashboard' : 'Create your faculty account'}
          </p>
          <div className="mt-4 p-3 bg-teal-50 rounded-md">
            <p className="text-sm text-teal-800 text-center">
              Admin access only. Use Email: admin@bitm.edu and Password: 123123
            </p>
          </div>
        </div>
